...
parser.add_argument('--seed', default=2025, type=int, help='Seed used for splitting sets') #1234
# --------------------------------------------------- I/O --------------------------------------------------------------
parser.add_argument('--data_dir', default='Dataset/TUAB', choices={'Dataset/Crowdsource', 'Dataset/DREAMER',
                                                                          'Dataset/STEW','Dataset/TUAB','Dataset/PhysioNetP300','Dataset/TUEV2'}, help='Data directory')
